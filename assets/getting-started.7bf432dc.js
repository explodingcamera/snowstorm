...
`,e.exports.jsxs(s.li,{children:["A major difference to ",e.exports.jsx(s.code,{children:"next.js"})," is that snowstorm focuses more on the experience of using a static site generator (=> ",e.exports.jsx(s.code,{children:"next.js"}),"'s export mode')."]}),`
`,e.exports.jsx(s.li,{children:"Routing can sometimes be a bit buggy, especially when pages have errors. I'm currently rewriting the client side page requesting code which will be ready for the 1.0 release."}),`
...
$ `,e.exports.jsx(s.span,{className:"token function",children:"npm"})," ",e.exports.jsx(s.span,{className:"token function",children:"install"}),` -S @snowstorm/core @snowstorm/cli react@rc react-dom@rc typescript
...
$ npx snowstorm dev
`]})}),`
`,e.exports.jsx("pre",{className:"language-terminal",children:e.exports.jsxs(s.p,{children:[e.exports.jsx("b",{children:"INFO"}),` starting snowstorm v0.0.1 (development mode)
`,e.exports.jsx("b",{children:"INFO"}),` started in 19ms
`,e.exports.jsx("b",{children:"INFO"})," listening on ",e.exports.jsx("u",{children:"http:/\u200B/localhost:2020/"})]})})]})}}export{p as default,l as title};
