import{j as s}from"./jsx-runtime.aa958f43.js";import"./index.6d5cacd0.js";function a(n){const e=Object.assign({h1:"h1",p:"p",pre:"pre",code:"code",span:"span"},n.components);return s.exports.jsxs(s.exports.Fragment,{children:[s.exports.jsx(e.h1,{children:"Configuration"}),`
...
`,s.exports.jsx(e.pre,{className:"language-tsx",children:s.exports.jsxs(e.code,{className:"language-tsx",children:[s.exports.jsx(e.span,{className:"token keyword",children:"export"})," ",s.exports.jsx(e.span,{className:"token keyword",children:"interface"})," ",s.exports.jsx(e.span,{className:"token class-name",children:s.exports.jsx(e.span,{className:"token maybe-class-name",children:"SnowstormConfig"})})," ",s.exports.jsx(e.span,{className:"token punctuation",children:"{"}),`
  ...
  site`,s.exports.jsx(e.span,{className:"token operator",children:":"})," ",s.exports.jsx(e.span,{className:"token punctuation",children:"{"}),`
    ...
    build`,s.exports.jsx(e.span,{className:"token operator",children:":"})," ",s.exports.jsx(e.span,{className:"token punctuation",children:"{"}),`
      ...
      `,s.exports.jsx(e.span,{className:"token comment",children:"// an array of snowstorm, vite and rollup plugins"}),`
      plugins`,s.exports.jsx(e.span,{className:"token operator",children:"?"}),s.exports.jsx(e.span,{className:"token operator",children:":"})," ",s.exports.jsx(e.span,{className:"token known-class-name class-name",children:"Array"}),s.exports.jsx(e.span,{className:"token operator",children:"<"}),s.exports.jsx(e.span,{className:"token maybe-class-name",children:"PluginOption"})," ",s.exports.jsx(e.span,{className:"token operator",children:"|"})," ",s.exports.jsx(e.span,{className:"token maybe-class-name",children:"PluginOption"}),s.exports.jsx(e.span,{className:"token punctuation",children:"["}),s.exports.jsx(e.span,{className:"token punctuation",children:"]"}),s.exports.jsx(e.span,{className:"token operator",children:">"}),s.exports.jsx(e.span,{className:"token punctuation",children:";"}),`
      ...
      `,s.exports.jsx(e.span,{className:"token comment",children:"// force module not to be externalized. can be helpful if esm packages are not compatible with nodejs's strict module resolution"}),`
      noExternal`,s.exports.jsx(e.span,{className:"token operator",children:"?"}),s.exports.jsx(e.span,{className:"token operator",children:":"})," ",s.exports.jsx(e.span,{className:"token known-class-name class-name",children:"Array"}),s.exports.jsx(e.span,{className:"token operator",children:"<"}),s.exports.jsx(e.span,{className:"token known-class-name class-name",children:"RegExp"})," ",s.exports.jsx(e.span,{className:"token operator",children:"|"})," ",s.exports.jsx(e.span,{className:"token builtin",children:"string"}),s.exports.jsx(e.span,{className:"token operator",children:">"}),s.exports.jsx(e.span,{className:"token punctuation",children:";"}),`
    `,s.exports.jsx(e.span,{className:"token punctuation",children:"}"}),s.exports.jsx(e.span,{className:"token punctuation",children:";"}),`
  ...
  `,s.exports.jsx(e.span,{className:"token punctuation",children:"}"}),s.exports.jsx(e.span,{className:"token punctuation",children:";"}),`
`,s.exports.jsx(e.span,{className:"token punctuation",children:"}"}),`
`]})})]})}function r(n={}){const{wrapper:e}=n.components||{};return e?s.exports.jsx(e,Object.assign({},n,{children:s.exports.jsx(a,n)})):a(n)}export{r as default};
