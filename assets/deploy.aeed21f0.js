...
`,s.exports.jsx(e.span,{className:"token punctuation",children:"}"}),`
`]})}),`
`,s.exports.jsx(e.p,{children:"If you have any issues in export mode, you can also test out a production build using the start command which might help reveal more errors."})]})}}export{p as default};
